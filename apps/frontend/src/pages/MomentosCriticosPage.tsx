...
export function MomentosCriticosPage() {
  ...
  const { mutate: crear, isPending: isCreating } = useCreateCriticalMoment(proyectoId);
  const { mutate: actualizar, isPending: isUpdating } = useUpdateCriticalMoment(proyectoId);
