// apps/backend/src/modules/artefactos/persona/persona.service.ts
import { Injectable } from '@nestjs/common';
import { UxArtifactService } from '../../../core/ux-artifact/ux-artifact.service';
import type { PersonaContenido } from '@observatorio-ux/shared-types';

@Injectable()
export class PersonaService {
  constructor(private readonly uxArtifact: UxArtifactService) {}

  crear(proyectoId: string, contenido: PersonaContenido, autorId: string) {
